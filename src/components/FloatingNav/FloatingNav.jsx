...
const sectionButtons = [
  { id: 'flights', label: 'Flights', icon: '✈', color: 'cyan' },
  { id: 'bowl', label: 'Bowl', icon: '🍜', color: 'yellow' },
  { id: 'friendship', label: 'Friends', icon: '👀', color: 'magenta' },
  { id: 'tracker', label: 'Tracker', icon: '📍', color: 'green' }
];
  ...
  return (
    <div className="floating-nav-shell">
      ...
      <div className="floating-nav-item">
        <a href="https://github.com/karen6099" target="_blank" className="nav-icon-btn" rel="noreferrer">
      ...
      {/* LinkedIn */}
      <div className="floating-nav-item">
        <a href="https://linkedin.com/in/karenlauhl" target="_blank" className="nav-icon-btn" rel="noreferrer">
      ...
      {/* DVD Toggle */}
      <div className="floating-nav-item">
        <button className="nav-icon-btn" title="Toggle DVD" onClick={withBlip('secondary', toggleDVD)}>
      ...
      {/* Starfield Toggle */}
      <div className="floating-nav-item">
        <button className="nav-icon-btn" title="Toggle starfield" onClick={withBlip('secondary', toggleStarfield)}>
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Theme Toggle */}
      <div className="floating-nav-item">
        <button id="floating-theme-toggle" className="nav-icon-btn" title="Toggle dark mode" onClick={withBlip('secondary', toggleDarkMode)}>
          <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg" className={`sun-icon ${isDarkMode ? 'hidden' : ''}`}>
          ...
          <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg" className={`moon-icon ${isDarkMode ? '' : 'hidden'}`}>
